  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        className="min-h-32 rounded-lg border border-slate-200 bg-white p-4 text-left text-sm text-slate-800 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] focus:outline-none"
        onFocus={() => {
