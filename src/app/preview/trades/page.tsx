...
export default async function PreviewTrades({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <WorkstationPreview diagnostic={params.scenario === "execution-mismatch"} initialId={typeof params.groupKey === "string" ? params.groupKey : undefined} filters={normalizeWorkstationFilters(params)} />;
}
