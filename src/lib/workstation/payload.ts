...
export const REVIEW_PACKAGE_TOO_LARGE = "This review exceeds the 4 MB save limit. Choose a smaller image, or download and remove older attachments, then retry. Your local draft is preserved.";
