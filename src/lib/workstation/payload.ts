...
export const REVIEW_PACKAGE_TOO_LARGE = "This review exceeds the 4 MB save limit. Download and remove older chart attachments, then retry. Your local draft is preserved.";
