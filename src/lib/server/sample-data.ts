...
export async function seedSampleData() {
  ...
  await prisma.positionSnapshot.createMany({
    data: [
      { accountId: account.id, instrumentId: spy.id, date: new Date("2026-02-23T00:00:00.000Z"), quantity: 0, avgCost: 0, unrealizedPnl: 0, currency: "USD" },
      { accountId: account.id, instrumentId: nvda.id, date: new Date("2026-02-23T00:00:00.000Z"), quantity: 0, avgCost: 0, unrealizedPnl: 0, currency: "USD" },
      { accountId: account.id, instrumentId: tsla.id, date: new Date("2026-02-23T00:00:00.000Z"), quantity: -50, avgCost: 182.1, unrealizedPnl: 0, currency: "USD" },
    ],
  });

  await prisma.dailySnapshot.createMany({
    data: [
      { accountId: account.id, date: new Date("2026-02-20T00:00:00.000Z"), equity: 100220, realizedPnl: 218, unrealizedPnl: 0, currency: "USD" },
      { accountId: account.id, date: new Date("2026-02-21T00:00:00.000Z"), equity: 100690, realizedPnl: 470, unrealizedPnl: 0, currency: "USD" },
      { accountId: account.id, date: new Date("2026-02-24T00:00:00.000Z"), equity: 100810, realizedPnl: 126, unrealizedPnl: 48, currency: "USD" },
    ],
  });
