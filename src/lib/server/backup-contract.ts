...
export const BACKUP_TABLES = [
  ...
  { key: "workstationTradeViews", prismaModel: "WorkstationTradeView", dependencies: [], restoreOrder: 225, canonicalRows: true, optionalInLegacy: true, notes: "Stable trade keys survive rematerialization; navigation has an independent revision." },
  ...
  { key: "marketCandles", prismaModel: "MarketCandle", dependencies: [], restoreOrder: 270, canonicalRows: true, notes: "Legacy restore compatibility only; new exports leave this recoverable cache empty." },
