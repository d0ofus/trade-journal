...
export const journalEntryPayloadSchema = z.object({
  ...
  idealExecutionOptions: z.array(z.string().trim().min(1).max(160)).max(80).optional().default([]),
  idealStopLossOptions: z.array(z.string().trim().min(1).max(160)).max(80).optional().default([]),
