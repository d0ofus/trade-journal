...
if (!["127.0.0.1:55439", "127.0.0.1:15439"].includes(target.databaseUrl.host) || target.databaseUrl.database !== "trades_workstation_auth_test") throw new Error("Authenticated workstation tests require the disposable local phase-two database.");
