...
if (!["127.0.0.1:55439", "127.0.0.1:15439"].includes(target.databaseUrl.host) || !["trades_workstation_auth_test", "trade_journal_notion_test"].includes(target.databaseUrl.database)) throw new Error("Authenticated workstation tests require a dedicated disposable local database.");
